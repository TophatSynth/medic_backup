...
# Surface anatomy 
Heart surfaces
- CHEESE ![[Pasted image 20260914130805.png|296]]
- Base is at the back 
- Anterior part is mainly right ventricle (bit of right atrium/left ventricle)
- Inferior part is mostly left ventricle 
- Right pulmonary surface is mainly right atrium
- Left pulmonary surface is mainly left ventricle -> leaves a cardiac impression in left lung
- Base is mainly left atrium and pulmonary veins 
	- Somewhat fixed posteriorly to the pericardium at the level of ~T6-8
- Apex is at left 5th intercostal space at the midclavicular line (IMPORTANT)
	- More superior and lateral in children 

Heart margins 
- ![[Pasted image 20260914131333.png|231]]
- 2D outline of the heart from the front 
- Right margin - right atrium 
- Left margin - left ventricle
- Inf margin - right and left ventricle 


# Internal structure
Septa
- Interatrial septum (IA)
...
- Right ventricle
	...
	- Max systolic pressure of 30mmHg
		- Pulmonary hypertension is >25mmHg in pulmonary artery
- Left ventricle
	- Wall thickness 8-12mm
	- Max systolic pressure of 120mmHg
...
- Atrioventricular valves
	- Tricuspid valves (right side)
		...
		- Immediately deep to right edge of sternum
	- Mitral/biscuspid valve (left side)
		- 2 cusps, attached to anulus fibrosus 
...
- Semilunar valves
	...
	- Aortic valve
		- 3 cusps - posterior, left, right
		- Nodule at each apex
	- Sinuses behind each valve
		- 3 pulmonary sinuses - fill during diastole to close the valve
		- 3 aortic sinuses - have the origins of left and right coronary arteries - the only blood vessels that fill during diastole 
...
- ![[Pasted image 20260914134343.png|192]]
