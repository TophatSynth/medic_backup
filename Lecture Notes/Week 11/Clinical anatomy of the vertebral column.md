## Herniated disk
- Gelatinous nucleus pulposus degenerates over time -> is replaced with fibrous tissue which is unable to bear the compressive forces
	- The weight is transferred to annulus fibrosus -> fissures -> rip -> herniation 
	- Water content of the annulus fibrosus also decreases with age -> causes tears 
- Mostly occur in the lumbar region
	- Compresses L5 or S1 part of the sciatic nerve 
- Diagnosis?
	- Clinical findings, MRI
- Treatment?
	- Analgesia, nonsteroidal anti-inflammatory drug
	- Keep active, not bed rest - but avoid activities which aggravate symptoms 
	- Physiotherapy
...
- Osteoporosis can be visualised DEXA
	- Look for the "Owl" - eyes (pedicles) and beak (spinous process) - normal = eyes open, bad = winking or unable to see structures 
...
- Cauda equina syndrome - collection of symptoms and signs resulting from severe compression of the cauda equina
	- SPINE 
		- Saddle anaesthesia - loss of feelings around ass, anus and genitals
		- Pain
		- Incontinence
		- Numbness
		- Emergency
