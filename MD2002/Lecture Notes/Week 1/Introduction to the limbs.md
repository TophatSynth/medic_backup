...
- Development
	...
	- Contains cells from somites and lateral plate mesoderm
	- Bud grows, then has programmed apoptosis -> forming the primitive fingers/toes (problems with this part -> syndactyly.... {fife hehe})
	- ![[Pasted image 20260126111523.png]]
	- 
...
- Origin and insertion 
	...
	- Depends on the specific movement - therefore use "attachment instead" - S/I attachement etc
- 

## Muscle contraction 
- ![[Pasted image 20260126111821.png]]
- Isometric contraction
	- Muscle tone changes but not the length - eg fighting against gravity
- Isotonic contraction - muscle length changes but not tone
	- Concentric contraction
		- Muscle contracts along its filament alignment
	- Eccentric contraction
		- Muscle elongates while under tension (usually as antagonist, slows down the action) - eg gym! lowering weights down slowly to work out the muscle even more

## Muscle terminology
- Prime mover
	- Primary mover
- Agonist
	- The one(s) directly acting to produce the desired movement
- Synergist
	- Assists the prime mover or prevent unwanted movements 
- Antagonist
...
- Superficial fascia (Hypodermis)
	- Just below the skin
	- Contains adipose tissue, superficial veins/nerves etc
- Deep/investing fascia - invests into the limb
	- Ensheaths the whole muscle as a continuous sheath
	- Intermuscular septa (pl. septae) - barrier between muscles
		- Forms compartments of muscles
		- Attachment for muscles, passages for nerves/vessels
...
- ![[Pasted image 20260126113241.png]]
- Dermatomyotome 
	- Can use to map damage to spinal nerves/cord/vertebrae


# Development of the limbs
## Rotation of the limbs
- ![[Pasted image 20260126113743.png]]
- Upper limb rotates laterally -> thumb lateral 
- Lower limb rotates medially -> big toe medially
- Starts with big toe/thumb pointing upwards, limb extended out 
- 

# Structure and movement of the limbs
## Plexuses
- Within dermatomyotomes, the peripheral nerves are more mixed up tgth (cervical and thoracic spinal nerves) <- plexuses
- 
...
## How to learn 
- Broad -> narrow 
- Categories, then exceptions
- Compartments of muscle -> nerve supplies of compartments -> details 
- 